                ...
                return `
                    <div class="form-group">
                        <div class="swag-customized-products-navigation">
                            <select class="form-select swag-customized-products-navigation" onmousedown="event.preventDefault()" tabindex="-1" aria-expanded="false" data-toggle="dropdown" data-boundary="viewport" data-offset="0,0" aria-haspopup="true">
